...
public class GuiDemo extends JFrame{
	...
	public GuiDemo() {
		...
		super("CS 1103 - AY2021-T3: Group 0013: Nhut Huynh");  // Specifies the string for the title bar of the window.
		...
		drawPanel.getTextItem().setText(
				...
				"CS 1103 - AY2021-T3: Group 0013\n" +
				"Student's name: Nhut Huynh"
			);
		drawPanel.getTextItem().setFontSize(36);
		drawPanel.getTextItem().setJustify(TextItem.LEFT);
		drawPanel.setBackgroundImage(Util.getImageResource("resources/images/vietnam.jpeg"));
		...
		//Add the background toolbar to the NORTH posision of the layout
	...
	private JMenu makeBackgroundMenu() {
		...
		menu.add(new ChooseBackgroundAction("Vietnam"));
	...
	/**
	 * Create the Background ToolBar with the same functionality as the Background Menu
	 * @return JtooklBar the background toolbar
	 */
	private JToolBar makeBackgroundToolbar() {
		...
		newPict.setToolTipText("Clear backgound picture");
		JButton saveImg = toolbar.add(saveImageAction);
		saveImg.setToolTipText("Save background picture");
		toolbar.addSeparator(new Dimension(15,0));
		toolbar.add(new ChooseBackgroundAction("Vietnam"));
    ...
    private class ChooseBackgroundAction extends AbstractAction {
    	...
    	ChooseBackgroundAction(String text) {
    		...
    		if (text.equals("Color...")) {
    			...
    			//create the icon for the Color action
    			...
    			//Add the icon "resources/action_icons/fileopen.png" for the "Custom..." action
    			putValue(Action.SMALL_ICON, 
